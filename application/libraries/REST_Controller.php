...
abstract class REST_Controller extends CI_Controller
{
	 ...
	 */
	public function response($data = array(), $http_code = null, $custom_headers = null)
	{
		global $CFG;
		...
		// Add a platform X-Header
		header("X-CI-Environment: " . ENVIRONMENT);

		// Add custom X-Headers, as provided by $customer_headers
